...
void AirsimROSWrapper::append_static_camera_tf(VehicleROS* vehicle_ros, const std::string& camera_name, const CameraSetting& camera_setting)
{
    ...
    mat_cam_optical.setValue(mat_cam_body.getColumn(1).getX(), mat_cam_body.getColumn(0).getX(), mat_cam_body.getColumn(2).getX(),
                             mat_cam_body.getColumn(1).getY(), mat_cam_body.getColumn(0).getY(), mat_cam_body.getColumn(2).getY(),
                             mat_cam_body.getColumn(1).getZ(), mat_cam_body.getColumn(0).getZ(), mat_cam_body.getColumn(2).getZ());
